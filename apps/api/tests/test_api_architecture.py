...
ROOT = Path(__file__).resolve().parents[1] / "src" / "morphix_api"
...
def test_domain_has_no_fastapi_or_aws_imports() -> None:
    banned = {"boto3", "botocore", "fastapi", "mangum"}
...
def test_application_depends_on_ports_not_fastapi_or_aws() -> None:
    banned = {"boto3", "botocore", "fastapi", "mangum"}
